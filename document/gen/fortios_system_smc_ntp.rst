:source: fortios_system_smc_ntp.py
...
.. raw:: html
    ...
    <li> <span class="li-head">system_smc_ntp</span> - Configure SMC NTP information. <span class="li-normal">type: dict</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.2 -> v7.4.2 </code></td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">channel</span> - SMC NTP client will send NTP packets through this channel. <span class="li-normal">type: int</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.2 -> v7.4.2 </code></td>
        ...
        <li> <span class="li-head">ntpserver</span> - Configure the FortiGate SMC to connect to an NTP server. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: ntpserver:id</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.2 -> v7.4.2 </code></td>
            ...
            <li> <span class="li-head">server</span> - IP address of the NTP server. <span class="li-normal">type: str</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.2 -> v7.4.2 </code></td>
        ...
        <li> <span class="li-head">ntpsync</span> - Enable/disable setting the FortiGate SMC system time by synchronizing with an NTP server. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
