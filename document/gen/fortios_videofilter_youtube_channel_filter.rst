:source: fortios_videofilter_youtube_channel_filter.py
...
-----------------------------
Supported Version Ranges: v7.0.0 -> v7.4.1
...
.. raw:: html
    ...
    <li> <span class="li-head">videofilter_youtube_channel_filter</span> - Configure YouTube channel filter. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>videofilter_youtube_channel_filter</td>
 ...
 <td><code class="docutils literal notranslate">v7.0.0 -> v7.4.1 </code></td>
        ...
        <li> <span class="li-head">default_action</span> - YouTube channel filter default action. <span class="li-normal">type: str</span> <span class="li-normal">choices: allow, monitor, block</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.4.3</code></td> </table>
        ...
        <li> <span class="li-head">entries</span> - YouTube filter entries. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: entries:id</span>
 ...
 <td><code class="docutils literal notranslate">v7.0.0 -> v7.4.1 </code></td>
            ...
            <ul class="ul-self">
            <li> <span class="li-head">action</span> - YouTube channel filter action. <span class="li-normal">type: str</span> <span class="li-normal">choices: allow, monitor, block, bypass</span>
 ...
 <td><code class="docutils literal notranslate">v7.0.0 -> v7.0.0</code></td>
            ...
            <li> <span class="li-head">channel_id</span> - Channel ID. <span class="li-normal">type: str</span>
 ...
 <td><code class="docutils literal notranslate">v7.0.0 -> v7.4.1 </code></td>
        ...
        <li> <span class="li-head">override_category</span> - Enable/disable overriding category filtering result. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
