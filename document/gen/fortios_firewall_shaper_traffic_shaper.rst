...
.. raw:: html
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.4.3</code></td> </table>
        ...
        <li> <span class="li-head">cos</span> - VLAN CoS mark. <span class="li-normal">type: str</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.0 -> 7.4.3 </code></td>
        ...
        <li> <span class="li-head">cos_marking</span> - Enable/disable VLAN CoS marking. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.4.3</code></td> </table>
        ...
        <li> <span class="li-head">cos_marking_method</span> - Select VLAN CoS marking method. <span class="li-normal">type: str</span> <span class="li-normal">choices: multi-stage, static</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.4.3</code></td> </table>
        ...
        <li> <span class="li-head">exceed_bandwidth</span> - Exceed bandwidth used for DSCP/VLAN CoS multi-stage marking. Units depend on the bandwidth-unit setting. <span class="li-normal">type: int</span>
 ...
 <td><code class="docutils literal notranslate">v6.2.0 -> 7.4.3 </code></td>
        ...
        <li> <span class="li-head">exceed_class_id</span> - Class ID for traffic in guaranteed-bandwidth and maximum-bandwidth. Source firewall.traffic-class.class-id. <span class="li-normal">type: int</span>
 ...
 <td><code class="docutils literal notranslate">v6.2.0 -> 7.4.3 </code></td>
        ...
        <li> <span class="li-head">exceed_cos</span> - VLAN CoS mark for traffic in [guaranteed-bandwidth, exceed-bandwidth]. <span class="li-normal">type: str</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.0 -> 7.4.3 </code></td>
        ...
        <li> <span class="li-head">exceed_dscp</span> - DSCP mark for traffic in guaranteed-bandwidth and exceed-bandwidth. <span class="li-normal">type: str</span>
