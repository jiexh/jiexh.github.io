...
.. raw:: html
    ...
    <li> <span class="li-head">system_stp</span> - Configure Spanning Tree Protocol (STP). <span class="li-normal">type: dict</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.2 -> v7.4.2 </code></td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">config_revision</span> - STP configuration revision (0 - 4294967295). <span class="li-normal">type: int</span>
 ...
 <tr>
 <td>config_revision</td>
 <td><code class="docutils literal notranslate">v6.0.0 -> v6.0.11 </code></td>
 </tr>
 </table>
 </div>
 </li>
        <li> <span class="li-head">forward_delay</span> - Forward delay (4 - 30 sec). <span class="li-normal">type: int</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.2 -> v7.4.2 </code></td>
        ...
        <li> <span class="li-head">hello_time</span> - Hello time (1 - 10 sec). <span class="li-normal">type: int</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.2 -> v7.4.2 </code></td>
        ...
        <li> <span class="li-head">max_age</span> - Maximum packet age (6 - 40 sec). <span class="li-normal">type: int</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.2 -> v7.4.2 </code></td>
        ...
        <li> <span class="li-head">max_hops</span> - Maximum number of hops (1 - 40). <span class="li-normal">type: int</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.2 -> v7.4.2 </code></td>
        ...
        <li> <span class="li-head">region_name</span> - Set region name. <span class="li-normal">type: str</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> v6.0.11 </code></td>
        ...
        <li> <span class="li-head">status</span> - Enable/disable STP settings. <span class="li-normal">type: str</span>
