...
.. raw:: html
 ...
 <td><code class="docutils literal notranslate">v6.4.0 -> 7.4.3 </code></td>
            ...
            <ul class="ul-self">
            <li> <span class="li-head">name</span> - Address name. Source firewall.address6.name firewall.vipgrp6.name firewall.vip6.name system.external-resource.name firewall .addrgrp6.name. <span class="li-normal">type: str</span> <span class="li-required">required: true</span>
