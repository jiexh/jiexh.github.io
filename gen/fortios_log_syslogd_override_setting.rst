...
.. raw:: html
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.6.0 </code></td>
        ...
        <li> <span class="li-head">source_ip_interface</span> - Source interface of syslog. Source system.interface.name. <span class="li-normal">type: str</span>
 ...
 <td><code class="docutils literal notranslate">v6.2.3 -> v6.2.3 </code></td>
        ...
        <li> <span class="li-head">use_management_vdom</span> - Enable/disable use of management VDOM as source VDOM for logs sent to syslog server. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
