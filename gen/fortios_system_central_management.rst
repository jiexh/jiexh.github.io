...
.. raw:: html
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.6.2</code></td>
        ...
        <li> <span class="li-head">ca_cert</span> - CA certificate to be used by FGFM protocol. Source certificate.ca.name. <span class="li-normal">type: str</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.6.2 </code></td>
        ...
        <li> <span class="li-head">fmg_update_http_header</span> - Enable/disable inclusion of HTTP header in update request. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td><code class="docutils literal notranslate">v6.2.0 -> v6.2.0</code></td>
        ...
        <li> <span class="li-head">local_cert</span> - Certificate to be used by FGFM protocol. Source certificate.local.name. <span class="li-normal">type: str</span>
