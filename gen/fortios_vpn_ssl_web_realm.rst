...
.. raw:: html
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.4.3</code></td> </table>
        ...
        <li> <span class="li-head">virtual_host_server_cert</span> - Name of the server certificate to used for this realm. Source vpn.certificate.local.name. <span class="li-normal">type: str</span>
 ...
 <tr>
 <td>virtual_host_server_cert</td>
