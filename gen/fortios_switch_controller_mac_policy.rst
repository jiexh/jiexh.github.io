:source: fortios_switch_controller_mac_policy.py
...
.. raw:: html
    ...
    <li> <span class="li-head">switch_controller_mac_policy</span> - Configure MAC policy to be applied on the managed FortiSwitch devices through NAC device. <span class="li-normal">type: dict</span>
