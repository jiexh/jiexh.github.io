:source: fortios_firewall_internet_service_botnet.py
...
.. raw:: html
    ...
    <li> <span class="li-head">firewall_internet_service_botnet</span> - Show Internet Service botnet. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>firewall_internet_service_botnet</td>
 ...
 <td><code class="docutils literal notranslate">v7.2.0 -> v7.2.0 </code></td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">id</span> - Internet Service Botnet ID. see <a href='#notes'>Notes</a>. <span class="li-normal">type: int</span> <span class="li-required">required: true</span>
 ...
 <td><code class="docutils literal notranslate">v7.2.0 -> v7.2.0 </code></td>
        ...
        <li> <span class="li-head">name</span> - Internet Service Botnet name. <span class="li-normal">type: str</span>
