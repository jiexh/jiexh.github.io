:source: fortios_switch_controller_ptp_interface_policy.py
...
Synopsis
--------
- This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the user to set and modify switch_controller_ptp feature and interface_policy category. Examples include all parameters and values need to be adjusted to datasources before usage. Tested with FOS v6.0.0
...
.. raw:: html
    ...
    <li> <span class="li-head">switch_controller_ptp_interface_policy</span> - PTP interface-policy configuration. <span class="li-normal">type: dict</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.1 -> 7.4.4 </code></td>
        ...
        <li> <span class="li-head">vlan</span> - PTP VLAN. Source system.interface.name. <span class="li-normal">type: str</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.1 -> 7.4.4 </code></td>
        ...
        <li> <span class="li-head">vlan_pri</span> - Configure PTP VLAN priority (0 - 7). <span class="li-normal">type: int</span>
