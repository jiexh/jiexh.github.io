:source: fortios_switch_controller_storm_control_policy.py
...
.. raw:: html
    ...
    <li> <span class="li-head">switch_controller_storm_control_policy</span> - Configure FortiSwitch storm control policy to be applied on managed-switch ports. <span class="li-normal">type: dict</span>
 ...
 <td><code class="docutils literal notranslate">v6.2.0 -> 7.4.4 </code></td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">broadcast</span> - Enable/disable storm control to drop/allow broadcast traffic in override mode. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
