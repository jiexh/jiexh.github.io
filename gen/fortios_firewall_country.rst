:source: fortios_firewall_country.py
...
.. raw:: html
    ...
    <li> <span class="li-head">firewall_country</span> - Define country table. <span class="li-normal">type: dict</span>
 ...
 <td><code class="docutils literal notranslate">v7.2.0 -> v7.2.0 </code></td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">id</span> - Country ID. see <a href='#notes'>Notes</a>. <span class="li-normal">type: int</span> <span class="li-required">required: true</span>
 ...
 <td><code class="docutils literal notranslate">v7.2.0 -> v7.2.0 </code></td>
        ...
        <li> <span class="li-head">name</span> - Country name. <span class="li-normal">type: str</span>
