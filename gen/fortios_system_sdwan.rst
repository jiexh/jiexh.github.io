...
.. raw:: html
 ...
 <td><code class="docutils literal notranslate">v6.4.0 -> 7.6.2</code></td>
            ...
            <li> <span class="li-head">agent_probe_timeout</span> - Time to wait before a probe packet is considered lost when detect-mode is agent (5000 - 3600*1000 msec). <span class="li-normal">type: int</span>
 ...
 <td><code class="docutils literal notranslate">v6.4.0 -> 7.6.2 </code></td>
            ...
            <li> <span class="li-head">remote_probe_timeout</span> - Time to wait before a probe packet is considered lost when detect-mode is remote (20 - 3600*1000 msec). <span class="li-normal">type: int</span>
 ...
 <td><code class="docutils literal notranslate">v6.4.0 -> 7.6.2 </code></td>
                ...
                <ul class="ul-self">
                <li> <span class="li-head">custom_profile_threshold</span> - Custom profile threshold for SLA to be marked as pass(0 - 10000000). <span class="li-normal">type: int</span>
 ...
 <tr>
 <td>custom_profile_threshold</td>
 <td><code class="docutils literal notranslate">v7.6.4 -> 7.6.2 </code></td>
 </tr>
 </table>
 </div>
 ...
 <td><code class="docutils literal notranslate">v6.4.0 -> 7.6.2 </code></td>
                ...
                <li> <span class="li-head">link_cost_factor</span> - Criteria on which to base link selection. <span class="li-normal">type: list</span> <span class="li-normal">choices: latency, jitter, packet-loss, custom-profile-1, mos, remote</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.1 -> 7.6.2 </code></td>
            ...
            <li> <span class="li-head">fib_best_match_force</span> - Enable/disable force using fib-best-match oif as outgoing interface. <span class="li-normal">type: str</span> <span class="li-normal">choices: disable, enable</span>
 ...
 <td><code class="docutils literal notranslate">v6.4.0 -> 7.6.2 </code></td>
            ...
            <li> <span class="li-head">internet_service_fortiguard</span> - FortiGuard Internet service name list. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: service:id/internet_service_fortiguard:name</span>
 ...
 <td><code class="docutils literal notranslate">v6.4.0 -> 7.6.2</code></td>
            ...
            <li> <span class="li-head">tie_break</span> - Method of selecting member if more than one meets the SLA. <span class="li-normal">type: str</span> <span class="li-normal">choices: zone, cfg-order, fib-best-match, priority, input-device</span>
 ...
 <td><code class="docutils literal notranslate">v6.4.0 -> 7.6.2 </code></td>
            ...
            <li> <span class="li-head">service_sla_tie_break</span> - Method of selecting member if more than one meets the SLA. <span class="li-normal">type: str</span> <span class="li-normal">choices: cfg-order, fib-best-match, priority, input-device</span>
