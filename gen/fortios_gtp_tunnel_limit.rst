:source: fortios_gtp_tunnel_limit.py
...
.. raw:: html
    ...
    <li> <span class="li-head">gtp_tunnel_limit</span> - GTP tunnel limiter. <span class="li-normal">type: dict</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.3 -> 7.4.4 </code></td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">name</span> - Tunnel limiter name. <span class="li-normal">type: str</span> <span class="li-required">required: true</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.3 -> 7.4.4 </code></td>
        ...
        <li> <span class="li-head">tunnel_limit</span> - Tunnel limit [1, 16000000]. <span class="li-normal">type: int</span>
