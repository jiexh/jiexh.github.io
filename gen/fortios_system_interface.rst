...
.. raw:: html
 ...
 <td><code class="docutils literal notranslate">v7.2.0 -> v7.2.0 </code></td>
        ...
        <li> <span class="li-head">aggregate_type</span> - Type of aggregation. <span class="li-normal">type: str</span> <span class="li-normal">choices: physical, vxlan</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.6.2 </code></td>
        ...
        <li> <span class="li-head">allowaccess</span> - Permitted types of management access to this interface. <span class="li-normal">type: list</span> <span class="li-normal">choices: ping, https, ssh, snmp, http, telnet, fgfm, radius-acct, probe-response, fabric, ftm, speed-test, scim, capwap</span>
 ...
 <td><code class="docutils literal notranslate">v7.2.0 -> v7.2.0 </code></td>
        ...
        <li> <span class="li-head">client_options</span> - DHCP client options. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: client_options:id</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.6.2</code></td>
        ...
        <li> <span class="li-head">default_purdue_level</span> - default purdue level of device detected on this interface. <span class="li-normal">type: str</span> <span class="li-normal">choices: 1, 1.5, 2, 2.5, 3, 3.5, 4, 5, 5.5</span>
 ...
 <td><code class="docutils literal notranslate">v7.2.0 -> v7.2.0 </code></td>
        ...
        <li> <span class="li-head">dhcp_broadcast_flag</span> - Enable/disable setting of the broadcast flag in messages sent by the DHCP client . <span class="li-normal">type: str</span> <span class="li-normal">choices: disable, enable</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.0 -> 7.6.2</code></td>
        ...
        <li> <span class="li-head">dhcp_classless_route_addition</span> - Enable/disable addition of classless static routes retrieved from DHCP server. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <tr>
 <td>dhcp_classless_route_addition</td>
 <td><code class="docutils literal notranslate">v7.0.1 -> 7.6.2 </code></td>
 </tr>
 <tr>
 <td>[enable]</td>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.6.2</code></td>
        ...
        <li> <span class="li-head">dhcp_relay_allow_no_end_option</span> - Enable/disable relaying DHCP messages with no end option. <span class="li-normal">type: str</span> <span class="li-normal">choices: disable, enable</span>
 ...
 <tr>
 <td>dhcp_relay_allow_no_end_option</td>
 ...
 <td><code class="docutils literal notranslate">v7.4.4 -> 7.6.2</code></td>
        ...
        <li> <span class="li-head">dhcp_relay_circuit_id</span> - DHCP relay circuit ID. <span class="li-normal">type: str</span>
 ...
 <td><code class="docutils literal notranslate">v6.2.0 -> v6.2.0</code></td>
        ...
        <li> <span class="li-head">dhcp_relay_ip</span> - DHCP relay IP address. <span class="li-normal">type: list</span> </li>
        <li> <span class="li-head">dhcp_relay_link_selection</span> - DHCP relay link selection. <span class="li-normal">type: str</span>
 ...
 <tr>
 <td>dhcp_relay_link_selection</td>
 <td><code class="docutils literal notranslate">v7.0.4 -> 7.6.2 </code></td>
 </tr>
 </table>
 </div>
 </li>
        <li> <span class="li-head">dhcp_relay_request_all_server</span> - Enable/disable sending of DHCP requests to all servers. <span class="li-normal">type: str</span> <span class="li-normal">choices: disable, enable</span>
 ...
 <tr>
 <td>dhcp_relay_request_all_server</td>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.6.2</code></td>
        ...
        <li> <span class="li-head">dhcp_relay_source_ip</span> - IP address used by the DHCP relay as its source IP. <span class="li-normal">type: str</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.6.2</code></td>
        ...
        <li> <span class="li-head">dhcp_relay_vrf_select</span> - VRF ID used for connection to server. <span class="li-normal">type: int</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.6.2 </code></td>
        ...
        <li> <span class="li-head">dhcp_smart_relay</span> - Enable/disable DHCP smart relay. <span class="li-normal">type: str</span> <span class="li-normal">choices: disable, enable</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.0 -> 7.6.2</code></td>
        ...
        <li> <span class="li-head">dhcp_snooping_server_list</span> - Configure DHCP server access list. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: dhcp_snooping_server_list:name</span>
 ...
 <tr>
 <td>dhcp_snooping_server_list</td>
 <td><code class="docutils literal notranslate">v7.0.1 -> 7.6.2 </code></td>
 </tr>
 </table>
 </div>
            ...
            <ul class="ul-self">
            <li> <span class="li-head">name</span> - DHCP server name. <span class="li-normal">type: str</span> <span class="li-required">required: true</span>
 ...
 <td><code class="docutils literal notranslate">v7.0.1 -> 7.6.2 </code></td>
            ...
            <li> <span class="li-head">server_ip</span> - IP address for DHCP server. <span class="li-normal">type: str</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.6.2</code></td>
        ...
        <li> <span class="li-head">dns_server_protocol</span> - DNS transport protocols. <span class="li-normal">type: list</span> <span class="li-normal">choices: cleartext, dot, doh</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> v7.6.2</code></td>
        ...
        <li> <span class="li-head">eap_ca_cert</span> - EAP CA certificate name. Source certificate.ca.name. <span class="li-normal">type: str</span>
 ...
 <td><code class="docutils literal notranslate">v7.2.0 -> 7.6.2 </code></td>
        ...
        <li> <span class="li-head">eap_identity</span> - EAP identity. <span class="li-normal">type: str</span>
 ...
 <td><code class="docutils literal notranslate">v7.2.0 -> 7.6.2 </code></td>
        ...
        <li> <span class="li-head">eap_method</span> - EAP method. <span class="li-normal">type: str</span> <span class="li-normal">choices: tls, peap</span>
 ...
 <td><code class="docutils literal notranslate">v7.2.0 -> 7.6.2</code></td>
        ...
        <li> <span class="li-head">eap_password</span> - EAP password. <span class="li-normal">type: str</span>
 ...
 <td><code class="docutils literal notranslate">v7.2.0 -> 7.6.2 </code></td>
        ...
        <li> <span class="li-head">eap_supplicant</span> - Enable/disable EAP-Supplicant. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td><code class="docutils literal notranslate">v7.2.0 -> 7.6.2</code></td>
        ...
        <li> <span class="li-head">eap_user_cert</span> - EAP user certificate name. Source certificate.local.name. <span class="li-normal">type: str</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.6.2 </code></td>
        ...
        <li> <span class="li-head">exclude_signatures</span> - Exclude IOT or OT application signatures. <span class="li-normal">type: list</span> <span class="li-normal">choices: iot, ot</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.6.2</code></td>
        ...
        <li> <span class="li-head">fail_action_on_extender</span> - Action on FortiExtender when interface fail. <span class="li-normal">type: str</span> <span class="li-normal">choices: soft-restart, hard-restart, reboot</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.6.2</code></td>
        ...
        <li> <span class="li-head">fail_alert_interfaces</span> - Names of the FortiGate interfaces to which the link failure alert is sent. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: fail_alert_interfaces:name</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.6.2 </code></td>
            ...
            <ul class="ul-self">
            <li> <span class="li-head">name</span> - Names of the non-virtual interface. Source system.interface.name. <span class="li-normal">type: str</span> <span class="li-required">required: true</span>
 ...
 <td><code class="docutils literal notranslate">v6.2.0 -> 7.6.2</code></td>
        ...
        <li> <span class="li-head">fortilink_split_interface</span> - Enable/disable FortiLink split interface to connect member link to different FortiSwitch in stack for uplink redundancy. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.6.2 </code></td>
        ...
        <li> <span class="li-head">forward_error_correction</span> - Configure forward error correction (FEC). <span class="li-normal">type: str</span> <span class="li-normal">choices: none, disable, cl91-rs-fec, cl74-fc-fec, auto</span>
 ...
 <tr>
 <td>forward_error_correction</td>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.6.2</code></td>
        ...
        <li> <span class="li-head">icmp_send_redirect</span> - Enable/disable sending of ICMP redirects. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.6.2 </code></td>
        ...
        <li> <span class="li-head">ike_saml_server</span> - Configure IKE authentication SAML server. Source user.saml.name. <span class="li-normal">type: str</span>
 ...
 <tr>
 <td>ike_saml_server</td>
 <td><code class="docutils literal notranslate">v7.2.0 -> 7.6.2 </code></td>
 </tr>
 </table>
 </div>
 </li>
        <li> <span class="li-head">inbandwidth</span> - Bandwidth limit for incoming traffic (0 - 80000000 kbps), 0 means unlimited. <span class="li-normal">type: int</span>
 ...
 <td><code class="docutils literal notranslate">v6.2.0 -> 7.6.2 </code></td>
        ...
        <li> <span class="li-head">ingress_spillover_threshold</span> - Ingress Spillover threshold (0 - 16776000 kbps), 0 means unlimited. <span class="li-normal">type: int</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.6.2 </code></td>
        ...
        <li> <span class="li-head">interconnect_profile</span> - Set interconnect profile. <span class="li-normal">type: str</span> <span class="li-normal">choices: default, profile1, profile2</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.6.2 </code></td>
        ...
        <li> <span class="li-head">ip_managed_by_fortiipam</span> - Enable/disable automatic IP address assignment of this interface by FortiIPAM. <span class="li-normal">type: str</span> <span class="li-normal">choices: inherit-global, enable, disable</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.6.2</code></td>
            ...
            <li> <span class="li-head">cli_conn6_status</span> - CLI IPv6 connection status. <span class="li-normal">type: int</span>
 ...
 <tr>
 <td>cli_conn6_status</td>
 <td><code class="docutils literal notranslate">v7.0.0 -> v7.0.5 </code></td>
 <td><code class="docutils literal notranslate">v7.2.0 -> v7.2.0 </code></td>
 </tr>
 </table>
 </div>
 </li>
            <li> <span class="li-head">client_options</span> - DHCP6 client options. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: ipv6/client_options:id</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> v7.0.5</code></td>
            ...
            <li> <span class="li-head">dhcp6_iapd_list</span> - DHCPv6 IA-PD list. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: ipv6/dhcp6_iapd_list:iaid</span>
 ...
 <td><code class="docutils literal notranslate">v7.0.2 -> 7.6.2 </code></td>
                ...
                <li> <span class="li-head">prefix_hint</span> - DHCPv6 prefix that will be used as a hint to the upstream DHCPv6 server. <span class="li-normal">type: str</span>
 ...
 <td><code class="docutils literal notranslate">v7.0.2 -> 7.6.2 </code></td>
                ...
                <li> <span class="li-head">prefix_hint_plt</span> - DHCPv6 prefix hint preferred life time (sec), 0 means unlimited lease time. <span class="li-normal">type: int</span>
 ...
 <tr>
 <td>prefix_hint_plt</td>
 <td><code class="docutils literal notranslate">v7.0.2 -> 7.6.2 </code></td>
 </tr>
 </table>
 </div>
 </li>
                <li> <span class="li-head">prefix_hint_vlt</span> - DHCPv6 prefix hint valid life time (sec). <span class="li-normal">type: int</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> v7.0.1 </code></td>
            ...
            <li> <span class="li-head">dhcp6_relay_interface_id</span> - DHCP6 relay interface ID. <span class="li-normal">type: str</span>
 ...
 <tr>
 <td>dhcp6_relay_interface_id</td>
 <td><code class="docutils literal notranslate">v7.4.1 -> 7.6.2 </code></td>
 </tr>
 </table>
 </div>
 </li>
            <li> <span class="li-head">dhcp6_relay_ip</span> - DHCPv6 relay IP address. <span class="li-normal">type: list</span> </li>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.6.2</code></td>
            ...
            <li> <span class="li-head">dhcp6_relay_source_interface</span> - Enable/disable use of address on this interface as the source address of the relay message. <span class="li-normal">type: str</span> <span class="li-normal">choices: disable, enable</span>
 ...
 <tr>
 <td>dhcp6_relay_source_interface</td>
 ...
 <td><code class="docutils literal notranslate">v7.2.4 -> 7.6.2</code></td>
            ...
            <li> <span class="li-head">dhcp6_relay_source_ip</span> - IPv6 address used by the DHCP6 relay as its source IP. <span class="li-normal">type: str</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.6.2 </code></td>
            ...
            <li> <span class="li-head">ip6_adv_rio</span> - Enable/disable sending advertisements with route information option. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.6.2 </code></td>
            ...
            <li> <span class="li-head">ip6_delegated_prefix_iaid</span> - IAID of obtained delegated-prefix from the upstream interface. <span class="li-normal">type: int</span>
 ...
 <tr>
 <td>ip6_delegated_prefix_iaid</td>
 <td><code class="docutils literal notranslate">v7.0.2 -> 7.6.2 </code></td>
 </tr>
 </table>
 </div>
 </li>
            <li> <span class="li-head">ip6_delegated_prefix_list</span> - Advertised IPv6 delegated prefix list. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: ipv6/ip6_delegated_prefix_list:prefix_id</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.6.2 </code></td>
                ...
                <li> <span class="li-head">rdnss</span> - Recursive DNS server option. <span class="li-normal">type: list</span> </li>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.6.2</code></td>
            ...
            <li> <span class="li-head">ip6_dnssl_list</span> - Advertised IPv6 DNSS list. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: ipv6/ip6_dnssl_list:domain</span>
 ...
 <td><code class="docutils literal notranslate">v7.6.1 -> 7.6.2 </code></td>
                ...
                <ul class="ul-self">
                <li> <span class="li-head">dnssl_life_time</span> - DNS search list time in seconds (0 - 4294967295). <span class="li-normal">type: int</span>
 ...
 <td><code class="docutils literal notranslate">v7.6.1 -> 7.6.2 </code></td>
            ...
            <li> <span class="li-head">ip6_extra_addr</span> - Extra IPv6 address prefixes of interface. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: ipv6/ip6_extra_addr:prefix</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.6.2</code></td>
            ...
            <li> <span class="li-head">ip6_prefix_list</span> - Advertised prefix list. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: ipv6/ip6_prefix_list:prefix</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.6.2</code></td>
                ...
                <li> <span class="li-head">dnssl</span> - DNS search list option. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: ipv6/ip6_prefix_list:prefix/dnssl:domain</span>
 ...
 <tr>
 <td>dnssl</td>
 <td><code class="docutils literal notranslate">v6.0.0 -> v7.6.0 </code></td>
 </tr>
 </table>
 </div>
 </li>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.6.2 </code></td>
            ...
            <li> <span class="li-head">ip6_prefix_mode</span> - Assigning a prefix from DHCP or RA. <span class="li-normal">type: str</span> <span class="li-normal">choices: dhcp6, ra</span>
 ...
 <td><code class="docutils literal notranslate">v7.0.0 -> 7.6.2</code></td>
            ...
            <li> <span class="li-head">ip6_rdnss_list</span> - Advertised IPv6 RDNSS list. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: ipv6/ip6_rdnss_list:rdnss</span>
 ...
 <td><code class="docutils literal notranslate">v7.6.1 -> 7.6.2 </code></td>
                ...
                <ul class="ul-self">
                <li> <span class="li-head">rdnss</span> - Recursive DNS server option. <span class="li-normal">type: str</span> <span class="li-required">required: true</span>
 ...
 <td><code class="docutils literal notranslate">v7.6.1 -> 7.6.2 </code></td>
                ...
                <li> <span class="li-head">rdnss_life_time</span> - Recursive DNS server life time in seconds (0 - 4294967295). <span class="li-normal">type: int</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.6.2 </code></td>
            ...
            <li> <span class="li-head">ip6_route_list</span> - Advertised route list. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: ipv6/ip6_route_list:route</span>
 ...
 <td><code class="docutils literal notranslate">v7.6.1 -> 7.6.2 </code></td>
                ...
                <ul class="ul-self">
                <li> <span class="li-head">route</span> - IPv6 route. <span class="li-normal">type: str</span> <span class="li-required">required: true</span>
 ...
 <td><code class="docutils literal notranslate">v7.6.1 -> 7.6.2 </code></td>
                ...
                <li> <span class="li-head">route_life_time</span> - Route life time in seconds (0 - 65535). <span class="li-normal">type: int</span>
 ...
 <tr>
 <td>route_life_time</td>
 <td><code class="docutils literal notranslate">v7.6.1 -> 7.6.2 </code></td>
 </tr>
 </table>
 </div>
 </li>
                <li> <span class="li-head">route_pref</span> - Set route preference to the interface . <span class="li-normal">type: str</span> <span class="li-normal">choices: medium, high, low</span>
 ...
 <td><code class="docutils literal notranslate">v7.6.1 -> 7.6.2</code></td>
            ...
            <li> <span class="li-head">ip6_route_pref</span> - Set route preference to the interface . <span class="li-normal">type: str</span> <span class="li-normal">choices: medium, high, low</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.6.2 </code></td>
            ...
            <li> <span class="li-head">ra_send_mtu</span> - Enable/disable sending link MTU in RA packet. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.6.2</code></td>
            ...
            <li> <span class="li-head">vrrp6</span> - IPv6 VRRP configuration. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: ipv6/vrrp6:vrid</span>
 ...
 <td><code class="docutils literal notranslate">v7.6.0 -> 7.6.2 </code></td>
                ...
                <li> <span class="li-head">vrdst6</span> - Monitor the route to this destination. <span class="li-normal">type: list</span> </li>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.6.2</code></td>
        ...
        <li> <span class="li-head">lacp_ha_secondary</span> - LACP HA secondary member. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.6.2 </code></td>
        ...
        <li> <span class="li-head">managed_device</span> - Available when FortiLink is enabled, used for managed devices through FortiLink interface. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: managed_device:name</span>
 ...
 <td><code class="docutils literal notranslate">v6.4.0 -> 7.6.2 </code></td>
        ...
        <li> <span class="li-head">mediatype</span> - Select SFP media interface type <span class="li-normal">type: str</span> <span class="li-normal">choices: none, gmii, sgmii, sr, lr, cr, sr2, lr2, cr2, sr4, lr4, cr4, sr8, lr8, cr8, cfp2-sr10, cfp2-lr4</span>
 ...
 <td><code class="docutils literal notranslate">v7.2.1 -> v7.2.4</code></td>
        ...
        <li> <span class="li-head">member</span> - Physical interfaces that belong to the aggregate or redundant interface. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: member:interface_name</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.6.2</code></td>
        ...
        <li> <span class="li-head">mirroring_direction</span> - Port mirroring direction. <span class="li-normal">type: str</span> <span class="li-normal">choices: rx, tx, both</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.2 -> v7.4.2</code></td>
        ...
        <li> <span class="li-head">mirroring_filter</span> - Mirroring filter. <span class="li-normal">type: dict</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.2 -> v7.4.2 </code></td>
            ...
            <ul class="ul-self">
            <li> <span class="li-head">filter_dport</span> - Destinatin port of mirroring filter. <span class="li-normal">type: int</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.2 -> v7.4.2 </code></td>
            ...
            <li> <span class="li-head">filter_dstip</span> - Destinatin IP and mask of mirroring filter. <span class="li-normal">type: str</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.2 -> v7.4.2 </code></td>
            ...
            <li> <span class="li-head">filter_protocol</span> - Protocol of mirroring filter. <span class="li-normal">type: int</span>
 ...
 <tr>
 <td>filter_protocol</td>
 <td><code class="docutils literal notranslate">v7.4.2 -> v7.4.2 </code></td>
 </tr>
 </table>
 </div>
 </li>
            <li> <span class="li-head">filter_sport</span> - Source port of mirroring filter. <span class="li-normal">type: int</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.2 -> v7.4.2 </code></td>
            ...
            <li> <span class="li-head">filter_srcip</span> - Source IP and mask of mirroring filter. <span class="li-normal">type: str</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.2 -> v7.4.2 </code></td>
        ...
        <li> <span class="li-head">mirroring_port</span> - Mirroring port. Source system.interface.name. <span class="li-normal">type: str</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.6.2</code></td>
        ...
        <li> <span class="li-head">netflow_sample_rate</span> - NetFlow sample rate.  Sample one packet every configured number of packets(1 - 65535). <span class="li-normal">type: int</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.6.2</code></td>
        ...
        <li> <span class="li-head">netflow_sampler_id</span> - Netflow sampler ID. <span class="li-normal">type: int</span>
 ...
 <tr>
 <td>netflow_sampler_id</td>
 <td><code class="docutils literal notranslate">v7.6.0 -> 7.6.2 </code></td>
 </tr>
 </table>
 </div>
 </li>
        <li> <span class="li-head">np_qos_profile</span> - NP QoS profile ID. <span class="li-normal">type: int</span>
 ...
 <tr>
 <td>np_qos_profile</td>
 <td><code class="docutils literal notranslate">v7.4.2 -> v7.4.2 </code></td>
 </tr>
 </table>
 </div>
 </li>
        <li> <span class="li-head">outbandwidth</span> - Bandwidth limit for outgoing traffic (0 - 80000000 kbps). <span class="li-normal">type: int</span>
 ...
 <td><code class="docutils literal notranslate">v7.2.0 -> v7.2.0 </code></td>
        ...
        <li> <span class="li-head">polling_interval</span> - sFlow polling interval in seconds (1 - 255). <span class="li-normal">type: int</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.6.2 </code></td>
        ...
        <li> <span class="li-head">port_mirroring</span> - Enable/disable NP port mirroring. <span class="li-normal">type: str</span> <span class="li-normal">choices: disable, enable</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.6.2</code></td>
        ...
        <li> <span class="li-head">reachable_time</span> - IPv4 reachable time in milliseconds (30000 - 3600000). <span class="li-normal">type: int</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.6.2 </code></td>
        ...
        <li> <span class="li-head">ring_rx</span> - RX ring size. <span class="li-normal">type: int</span>
 ...
 <td>ring_rx</td>
        ...
        <li> <span class="li-head">ring_tx</span> - TX ring size. <span class="li-normal">type: int</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.6.2</code></td>
        ...
        <li> <span class="li-head">secondaryip</span> - Second IP address of interface. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: secondaryip:id</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.6.2 </code></td>
            ...
            <ul class="ul-self">
            <li> <span class="li-head">allowaccess</span> - Management access settings for the secondary IP address. <span class="li-normal">type: list</span> <span class="li-normal">choices: ping, https, ssh, snmp, http, telnet, fgfm, radius-acct, probe-response, fabric, ftm, speed-test, scim, capwap</span>
 ...
 <td><code class="docutils literal notranslate">v7.2.0 -> v7.2.0 </code></td>
            ...
            <li> <span class="li-head">secip_relay_ip</span> - DHCP relay IP address. <span class="li-normal">type: list</span> </li>
            </ul>
        <li> <span class="li-head">security_8021x_dynamic_vlan_id</span> - VLAN ID for virtual switch. <span class="li-normal">type: int</span>
 ...
 <tr>
 <td>security_8021x_dynamic_vlan_id</td>
 <td><code class="docutils literal notranslate">v7.4.2 -> v7.4.2 </code></td>
 </tr>
 </table>
 </div>
 </li>
        <li> <span class="li-head">security_8021x_master</span> - 802.1X master virtual-switch. <span class="li-normal">type: str</span>
 ...
 <tr>
 <td>security_8021x_master</td>
 <td><code class="docutils literal notranslate">v7.4.2 -> v7.4.2 </code></td>
 </tr>
 </table>
 </div>
 </li>
        <li> <span class="li-head">security_8021x_member_mode</span> - 802.1X member mode. <span class="li-normal">type: str</span> <span class="li-normal">choices: switch, disable</span>
 ...
 <tr>
 <td>security_8021x_member_mode</td>
 <td><code class="docutils literal notranslate">v7.4.2 -> v7.4.2 </code></td>
 </tr>
 <tr>
 <td>[switch]</td>
 ...
 <td><code class="docutils literal notranslate">v7.4.2 -> v7.4.2</code></td>
        ...
        <li> <span class="li-head">security_8021x_mode</span> - 802.1X mode. <span class="li-normal">type: str</span> <span class="li-normal">choices: default, dynamic-vlan, fallback, slave</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.6.2 </code></td>
        ...
        <li> <span class="li-head">security_groups</span> - User groups that can authenticate with the captive portal. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: security_groups:name</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.6.2 </code></td>
            ...
            <ul class="ul-self">
            <li> <span class="li-head">name</span> - Names of user groups that can authenticate with the captive portal. Source user.group.name. <span class="li-normal">type: str</span> <span class="li-required">required: true</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.6.2 </code></td>
        ...
        <li> <span class="li-head">security_ip_auth_bypass</span> - Enable/disable IP authentication bypass. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td><code class="docutils literal notranslate">v7.6.0 -> 7.6.2</code></td>
        ...
        <li> <span class="li-head">security_mac_auth_bypass</span> - Enable/disable MAC authentication bypass. <span class="li-normal">type: str</span> <span class="li-normal">choices: mac-auth-only, enable, disable</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> v6.2.7</code></td>
        ...
        <li> <span class="li-head">stp_edge</span> - Enable/disable as STP edge port. <span class="li-normal">type: str</span> <span class="li-normal">choices: disable, enable</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.2 -> v7.4.2</code></td>
        ...
        <li> <span class="li-head">stp_ha_secondary</span> - Control STP behavior on HA secondary. <span class="li-normal">type: str</span> <span class="li-normal">choices: disable, enable, priority-adjust</span>
 ...
 <td>stp_ha_slave</td>
 <td><code class="docutils literal notranslate">v6.0.0 -> v6.2.7 </code></td>
 <td><code class="docutils literal notranslate">v6.4.1 -> v6.4.4 </code></td>
 </tr>
 <tr>
 <td>[disable]</td>
 <td><code class="docutils literal notranslate">v6.0.0 -> v6.2.7</code></td>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.6.2 </code></td>
        ...
        <li> <span class="li-head">sw_algorithm</span> - Frame distribution algorithm for switch. <span class="li-normal">type: str</span> <span class="li-normal">choices: l2, l3, eh</span>
 ...
 <td><code class="docutils literal notranslate">v6.4.4 -> v7.6.0 </code></td>
 </tr>
 </table>
 </div>
 </li>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.6.2</code></td>
        ...
        <li> <span class="li-head">switch_controller_arp_inspection</span> - Enable/disable/Monitor FortiSwitch ARP inspection. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable, monitor</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.6.2</code></td>
        ...
        <li> <span class="li-head">switch_controller_dynamic</span> - Integrated FortiLink settings for managed FortiSwitch. Source switch-controller.fortilink-settings.name. <span class="li-normal">type: str</span>
 ...
 <tr>
 <td>switch_controller_dynamic</td>
 <td><code class="docutils literal notranslate">v7.0.0 -> 7.6.2 </code></td>
 </tr>
 </table>
 </div>
 </li>
        <li> <span class="li-head">switch_controller_feature</span> - Interface"s purpose when assigning traffic (read only). <span class="li-normal">type: str</span> <span class="li-normal">choices: none, default-vlan, quarantine, rspan, voice, video, nac, nac-segment</span>
 ...
 <td><code class="docutils literal notranslate">v6.4.0 -> 7.6.2 </code></td>
        ...
        <li> <span class="li-head">switch_controller_nac</span> - Integrated FortiLink settings for managed FortiSwitch. Source switch-controller.fortilink-settings.name. <span class="li-normal">type: str</span>
 ...
 <td><code class="docutils literal notranslate">v6.4.0 -> 7.6.2 </code></td>
        ...
        <li> <span class="li-head">switch_controller_netflow_collect</span> - NetFlow collection and processing. <span class="li-normal">type: str</span> <span class="li-normal">choices: disable, enable</span>
 ...
 <tr>
 <td>switch_controller_netflow_collect</td>
 <td><code class="docutils literal notranslate">v7.2.1 -> 7.6.2 </code></td>
 </tr>
 <tr>
 <td>[disable]</td>
 ...
 <td><code class="docutils literal notranslate">v7.2.1 -> 7.6.2</code></td>
        ...
        <li> <span class="li-head">switch_controller_offload</span> - Enable/disable managed FortiSwitch routing offload. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <tr>
 <td>switch_controller_offload</td>
 <td><code class="docutils literal notranslate">v7.4.1 -> 7.6.2 </code></td>
 </tr>
 <tr>
 <td>[enable]</td>
 ...
 <td><code class="docutils literal notranslate">v7.4.1 -> 7.6.2</code></td>
        ...
        <li> <span class="li-head">switch_controller_offload_gw</span> - Enable/disable managed FortiSwitch routing offload gateway. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <tr>
 <td>switch_controller_offload_gw</td>
 <td><code class="docutils literal notranslate">v7.4.1 -> 7.6.2 </code></td>
 </tr>
 <tr>
 <td>[enable]</td>
 ...
 <td><code class="docutils literal notranslate">v7.4.1 -> 7.6.2</code></td>
        ...
        <li> <span class="li-head">switch_controller_offload_ip</span> - IP for routing offload on FortiSwitch. <span class="li-normal">type: str</span>
 ...
 <tr>
 <td>switch_controller_offload_ip</td>
 <td><code class="docutils literal notranslate">v7.4.1 -> 7.6.2 </code></td>
 </tr>
 </table>
 </div>
 ...
 <td><code class="docutils literal notranslate">v6.2.0 -> 7.6.2 </code></td>
        ...
        <li> <span class="li-head">system_id</span> - Define a system ID for the aggregate interface. <span class="li-normal">type: str</span>
 ...
 <td><code class="docutils literal notranslate">v7.0.2 -> 7.6.2 </code></td>
        ...
        <li> <span class="li-head">system_id_type</span> - Method in which system ID is generated. <span class="li-normal">type: str</span> <span class="li-normal">choices: auto, user</span>
