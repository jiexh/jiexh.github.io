...
.. raw:: html
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.6.0 </code></td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">active_flow_timeout</span> - Timeout to report active flows (60 - 3600 sec). <span class="li-normal">type: int</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> v7.4.1 </code></td>
        ...
        <li> <span class="li-head">collectors</span> - Netflow collectors. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: collectors:id</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.2 -> 7.6.0 </code></td>
            ...
            <li> <span class="li-head">source_ip_interface</span> - Name of the interface used to determine the source IP for exporting packets. Source system.interface.name. <span class="li-normal">type: str</span>
 ...
 <td><code class="docutils literal notranslate">v7.6.1 -> 7.6.0 </code></td>
        ...
        <li> <span class="li-head">exclusion_filters</span> - Exclusion filters <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: exclusion_filters:id</span>
 ...
 <td><code class="docutils literal notranslate">v7.6.0 -> 7.6.0 </code></td>
            ...
            <ul class="ul-self">
            <li> <span class="li-head">destination_ip</span> - Session destination address. <span class="li-normal">type: str</span>
 ...
 <td><code class="docutils literal notranslate">v7.6.0 -> 7.6.0 </code></td>
            ...
            <li> <span class="li-head">destination_port</span> - Session destination port number or range. <span class="li-normal">type: str</span>
 ...
 <td><code class="docutils literal notranslate">v7.6.0 -> 7.6.0 </code></td>
            ...
            <li> <span class="li-head">id</span> - Filter ID. see <a href='#notes'>Notes</a>. <span class="li-normal">type: int</span> <span class="li-required">required: true</span>
 ...
 <td><code class="docutils literal notranslate">v7.6.0 -> 7.6.0 </code></td>
            ...
            <li> <span class="li-head">protocol</span> - Session IP protocol (0 - 255). <span class="li-normal">type: int</span>
 ...
 <td><code class="docutils literal notranslate">v7.6.0 -> 7.6.0 </code></td>
            ...
            <li> <span class="li-head">source_ip</span> - Session source address. <span class="li-normal">type: str</span>
 ...
 <td><code class="docutils literal notranslate">v7.6.0 -> 7.6.0 </code></td>
            ...
            <li> <span class="li-head">source_port</span> - Session source port number or range. <span class="li-normal">type: str</span>
