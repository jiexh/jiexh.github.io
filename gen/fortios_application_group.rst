...
.. raw:: html
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.4.3 </code></td>
        ...
        <li> <span class="li-head">category</span> - Application category ID list. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: category:id</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.4.3</code></td> </table>
        ...
        <li> <span class="li-head">risk</span> - Risk, or impact, of allowing traffic from this application to occur (1 - 5; Low, Elevated, Medium, High, and Critical). <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: risk:level</span>
 ...
 <td><code class="docutils literal notranslate">v7.0.0 -> 7.4.3 </code></td>
        ...
        <li> <span class="li-head">type</span> - Application group type. <span class="li-normal">type: str</span> <span class="li-normal">choices: application, filter, category</span>
