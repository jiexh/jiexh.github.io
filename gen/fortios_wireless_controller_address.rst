:source: fortios_wireless_controller_address.py
...
.. raw:: html
    ...
    <li> <span class="li-head">wireless_controller_address</span> - Configure the client with its MAC address. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>wireless_controller_address</td>
 ...
 <td><code class="docutils literal notranslate">v6.2.0 -> v7.0.12 </code></td>
        ...
        <li> <span class="li-head">policy</span> - Allow or block the client with this MAC address. <span class="li-normal">type: str</span> <span class="li-normal">choices: allow, deny</span>
