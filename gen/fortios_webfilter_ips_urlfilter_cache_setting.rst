...
.. raw:: html
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.4.4 </code></td>
        ...
        <li> <span class="li-head">extended_ttl</span> - Extend time to live beyond reported by DNS. Use of 0 means use DNS server"s TTL. <span class="li-normal">type: int</span>
