:source: fortios_casb_attribute_match.py
...
Synopsis
--------
- This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the user to set and modify casb feature and attribute_match category. Examples include all parameters and values need to be adjusted to datasources before usage. Tested with FOS v6.0.0
...
.. raw:: html
 ...
 <td><code class="docutils literal notranslate">v7.6.1 -> 7.6.0 </code></td>
        ...
        <li> <span class="li-head">attribute</span> - CASB tenant match rules. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: attribute:name</span>
