:source: fortios_system_speed_test_schedule.py
...
.. raw:: html
 ...
 <td><code class="docutils literal notranslate">v7.0.0 -> 7.4.4 </code></td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">ctrl_port</span> - Port of the controller to get access token. <span class="li-normal">type: int</span>
