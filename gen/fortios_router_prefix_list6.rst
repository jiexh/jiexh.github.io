...
.. raw:: html
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.4.4 </code></td>
        ...
        <li> <span class="li-head">rule</span> - IPv6 prefix list rule. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: rule:id</span>
