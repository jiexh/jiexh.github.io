...
.. raw:: html
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> v7.0.0 </code></td>
        ...
        <li> <span class="li-head">poolname</span> - Policy IP pool names. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: poolname:name</span>
