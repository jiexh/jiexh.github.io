:source: fortios_web_proxy_isolator_server.py

:orphan:

.. fortios_web_proxy_isolator_server:
...
Synopsis
--------
- This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the user to set and modify web_proxy feature and isolator_server category. Examples include all parameters and values need to be adjusted to datasources before usage. Tested with FOS v6.0.0
...
.. raw:: html
    ...
    <li> <span class="li-head">web_proxy_isolator_server</span> - Configure forward-server addresses. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>web_proxy_isolator_server</td>
 <td><code class="docutils literal notranslate">v7.6.1 -> 7.6.0 </code></td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">addr_type</span> - Address type of the forwarding proxy server: IP or FQDN. <span class="li-normal">type: str</span> <span class="li-normal">choices: ip, ipv6, fqdn</span>
