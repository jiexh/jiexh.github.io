:source: fortios_monitoring_np6_ipsec_engine.py
...
-----------------------------
Supported Version Ranges: v6.0.0 -> v7.4.1, v7.4.3 -> 7.4.4
...
.. raw:: html
    ...
    <li> <span class="li-head">monitoring_np6_ipsec_engine</span> - Configure NP6 IPsec engine status monitoring. <span class="li-normal">type: dict</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.3 -> 7.4.4 </code></td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">interval</span> - IPsec engine status check interval (1 - 60 seconds). <span class="li-normal">type: int</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.3 -> 7.4.4 </code></td>
        ...
        <li> <span class="li-head">status</span> - Enable/disable NP6 IPsec engine status monitoring. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
