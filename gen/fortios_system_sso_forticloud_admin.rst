:source: fortios_system_sso_forticloud_admin.py
...
.. raw:: html
    ...
    <li> <span class="li-head">system_sso_forticloud_admin</span> - Configure FortiCloud SSO admin users. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>system_sso_forticloud_admin</td>
 <td><code class="docutils literal notranslate">v7.0.0 -> 7.4.4 </code></td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">accprofile</span> - FortiCloud SSO admin user access profile. Source system.accprofile.name. <span class="li-normal">type: str</span>
