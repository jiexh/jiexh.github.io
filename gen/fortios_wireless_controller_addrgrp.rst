:source: fortios_wireless_controller_addrgrp.py
...
-----------------------------
Supported Version Ranges: v6.2.0 -> v7.0.12
...
.. raw:: html
    ...
    <li> <span class="li-head">wireless_controller_addrgrp</span> - Configure the MAC address group. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>wireless_controller_addrgrp</td>
 ...
 <td><code class="docutils literal notranslate">v6.2.0 -> v7.0.12 </code></td>
        ...
        <li> <span class="li-head">default_policy</span> - Allow or block the clients with MAC addresses that are not in the group. <span class="li-normal">type: str</span> <span class="li-normal">choices: allow, deny</span>
 ...
 <td><code class="docutils literal notranslate">v6.2.0 -> v7.0.12</code></td>
        ...
        <li> <span class="li-head">id</span> - ID. <span class="li-normal">type: str</span> <span class="li-required">required: true</span>
