:source: fortios_switch_controller_ptp_policy.py
...
.. raw:: html
    ...
    <li> <span class="li-head">switch_controller_ptp_policy</span> - PTP policy configuration. <span class="li-normal">type: dict</span>
 ...
 <td><code class="docutils literal notranslate">v6.4.4 -> v7.4.0 </code></td>
 </tr>
 </table>
 </div>
 </li>
 ...
 <td><code class="docutils literal notranslate">v6.4.4 -> v7.4.0 </code></td>
        ...
        <li> <span class="li-head">status</span> - Enable/disable PTP policy. <span class="li-normal">type: str</span> <span class="li-normal">choices: disable, enable</span>
