:source: fortios_firewall_region.py
...
-----------------------------
Supported Version Ranges: v6.4.0 -> v7.0.5
, v7.2.0
...
.. raw:: html
    ...
    <li> <span class="li-head">firewall_region</span> - Define region table. <span class="li-normal">type: dict</span>
 ...
 <td><code class="docutils literal notranslate">v7.2.0 -> v7.2.0 </code></td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">city</span> - City ID list. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: city:id</span>
 ...
 <td><code class="docutils literal notranslate">v7.2.0 -> v7.2.0 </code></td>
            ...
            <ul class="ul-self">
            <li> <span class="li-head">id</span> - City ID. see <a href='#notes'>Notes</a>. <span class="li-normal">type: int</span> <span class="li-required">required: true</span>
 ...
 <td><code class="docutils literal notranslate">v7.2.0 -> v7.2.0 </code></td>
        ...
        <li> <span class="li-head">id</span> - Region ID. see <a href='#notes'>Notes</a>. <span class="li-normal">type: int</span> <span class="li-required">required: true</span>
 ...
 <td><code class="docutils literal notranslate">v7.2.0 -> v7.2.0 </code></td>
        ...
        <li> <span class="li-head">name</span> - Region name. <span class="li-normal">type: str</span>
