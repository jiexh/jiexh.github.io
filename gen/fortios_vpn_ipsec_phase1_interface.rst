...
.. raw:: html
 ...
 <td><code class="docutils literal notranslate">v7.2.0 -> 7.4.4</code></td>
        ...
        <li> <span class="li-head">monitor</span> - IPsec interface as backup for primary interface. Source vpn.ipsec.phase1-interface.name. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: monitor:name</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.4 -> 7.4.4 </code></td>
        ...
        <li> <span class="li-head">monitor_dict</span> - IPsec interface as backup for primary interface.(Use the parameter monitor instead if the fortios firmwear version <= 7.4.0.) <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: monitor_dict:name</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.4 -> 7.4.4 </code></td>
        ...
        <li> <span class="li-head">remote_gw_match</span> - Set type of IPv4 remote gateway address matching. <span class="li-normal">type: str</span> <span class="li-normal">choices: any, ipmask, iprange, geography</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.4.4</code></td>
        ...
        <li> <span class="li-head">transport</span> - Set IKE transport protocol. <span class="li-normal">type: str</span> <span class="li-normal">choices: udp, udp-fallback-tcp, tcp</span>
