...
.. raw:: html
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.6.2 </code></td>
        ...
        <li> <span class="li-head">peer_egress_shaping</span> - Enable/disable peer egress shaping. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td><code class="docutils literal notranslate">v7.6.4 -> 7.6.2</code></td>
        ...
        <li> <span class="li-head">peer_egress_shaping_value</span> - Configure outbound bandwidth to use for peer egress shaping in kbps (0 - 80000000). <span class="li-normal">type: int</span>
 ...
 <tr>
 <td>peer_egress_shaping_value</td>
 <td><code class="docutils literal notranslate">v7.6.4 -> 7.6.2 </code></td>
 </tr>
 </table>
 </div>
