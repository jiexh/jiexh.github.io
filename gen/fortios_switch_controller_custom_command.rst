...
.. raw:: html
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.4.4 </code></td>
        ...
        <li> <span class="li-head">command_name</span> - Command name called by the FortiGate switch controller in the execute command. <span class="li-normal">type: str</span> <span class="li-required">required: true</span>
