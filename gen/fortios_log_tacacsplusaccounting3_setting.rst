:source: fortios_log_tacacsplusaccounting3_setting.py
...
Synopsis
--------
- This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the user to set and modify log_tacacsplusaccounting3 feature and setting category. Examples include all parameters and values need to be adjusted to datasources before usage. Tested with FOS v6.0.0
...
.. raw:: html
    ...
    <li> <span class="li-head">log_tacacsplusaccounting3_setting</span> - Settings for TACACS+ accounting. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>log_tacacsplusaccounting3_setting</td>
