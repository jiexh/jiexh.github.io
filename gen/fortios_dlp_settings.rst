...
.. raw:: html
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.4.4 </code></td>
        ...
        <li> <span class="li-head">chunk_size</span> - Maximum fingerprint chunk size. Caution, changing this setting will flush the entire database. <span class="li-normal">type: int</span>
