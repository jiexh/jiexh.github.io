:source: fortios_pfcp_message_filter.py
...
.. raw:: html
    ...
    <li> <span class="li-head">pfcp_message_filter</span> - Message filter for PFCP messages. <span class="li-normal">type: dict</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.3 -> 7.4.4 </code></td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">association_release</span> - Allow or deny PFCP association release request (9) and PFCP association release response (10). <span class="li-normal">type: str</span> <span class="li-normal">choices: allow, deny</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.3 -> 7.4.4 </code></td>
        ...
        <li> <span class="li-head">node_report</span> - Allow or deny PFCP node report request (12) and PFCP node report response (13). <span class="li-normal">type: str</span> <span class="li-normal">choices: allow, deny</span>
 ...
 <tr>
 <td>unknown_message_allow_list</td>
 <td><code class="docutils literal notranslate">v7.0.1 -> v7.0.8 </code></td>
 <td><code class="docutils literal notranslate">v7.2.0 -> v7.2.4 </code></td>
 <td><code class="docutils literal notranslate">v7.4.3 -> 7.4.4 </code></td>
 </tr>
            ...
            <ul class="ul-self">
            <li> <span class="li-head">id</span> - Message IDs (range from 1 to 255). see <a href='#notes'>Notes</a>. <span class="li-normal">type: int</span> <span class="li-required">required: true</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.3 -> 7.4.4 </code></td>
        ...
        <li> <span class="li-head">version_not_support</span> - Allow or deny PFCP version not supported response (11). <span class="li-normal">type: str</span> <span class="li-normal">choices: allow, deny</span>
