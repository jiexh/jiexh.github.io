...
.. raw:: html
    ...
    <li> <span class="li-head">firewall_pfcp</span> - Configure PFCP. <span class="li-normal">type: dict</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.3 -> 7.4.4 </code></td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">denied_log</span> - Enable/disable logging denied PFCP packets. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.3 -> 7.4.4 </code></td>
        ...
        <li> <span class="li-head">max_message_length</span> - Maximum message length. <span class="li-normal">type: int</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.3 -> 7.4.4 </code></td>
        ...
        <li> <span class="li-head">message_filter</span> - PFCP message filter. Source pfcp.message-filter.name. <span class="li-normal">type: str</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.3 -> 7.4.4 </code></td>
        ...
        <li> <span class="li-head">min_message_length</span> - Minimum message length. <span class="li-normal">type: int</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.3 -> 7.4.4 </code></td>
        ...
        <li> <span class="li-head">monitor_mode</span> - PFCP monitor mode. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable, vdom</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.3 -> 7.4.4 </code></td>
        ...
        <li> <span class="li-head">pfcp_timeout</span> - Set PFCP timeout (in seconds). <span class="li-normal">type: int</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.3 -> 7.4.4 </code></td>
        ...
        <li> <span class="li-head">traffic_count_log</span> - Enable/disable logging session traffic counter. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
