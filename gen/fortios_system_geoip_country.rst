:source: fortios_system_geoip_country.py
...
.. raw:: html
    ...
    <li> <span class="li-head">system_geoip_country</span> - Define geoip country name-ID table. <span class="li-normal">type: dict</span>
 ...
 <td><code class="docutils literal notranslate">v7.2.0 -> v7.2.0 </code></td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">id</span> - Country ID. <span class="li-normal">type: str</span> <span class="li-required">required: true</span>
