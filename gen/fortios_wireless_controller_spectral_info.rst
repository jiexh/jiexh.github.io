:source: fortios_wireless_controller_spectral_info.py
...
.. raw:: html
    ...
    <li> <span class="li-head">wireless_controller_spectral_info</span> - Wireless controller spectrum analysis. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>wireless_controller_spectral_info</td>
 ...
 <td><code class="docutils literal notranslate">v7.2.0 -> v7.2.0 </code></td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">set_wtp_id</span> - WTP ID. <span class="li-normal">type: str</span>
