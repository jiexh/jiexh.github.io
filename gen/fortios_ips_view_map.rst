:source: fortios_ips_view_map.py
...
-----------------------------
Supported Version Ranges: v6.2.0, v6.2.5 -> v7.0.5
, v7.2.0
...
.. raw:: html
    ...
    <li> <span class="li-head">ips_view_map</span> - Configure IPS view-map. <span class="li-normal">type: dict</span>
 ...
 <td><code class="docutils literal notranslate">v6.2.5 -> v7.0.5 </code></td>
 <td><code class="docutils literal notranslate">v7.2.0 -> v7.2.0 </code></td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">id</span> - View ID. see <a href='#notes'>Notes</a>. <span class="li-normal">type: int</span> <span class="li-required">required: true</span>
 ...
 <td><code class="docutils literal notranslate">v7.2.0 -> v7.2.0 </code></td>
        ...
        <li> <span class="li-head">id_policy_id</span> - ID-based policy ID. <span class="li-normal">type: int</span>
 ...
 <td><code class="docutils literal notranslate">v7.2.0 -> v7.2.0 </code></td>
        ...
        <li> <span class="li-head">vdom_id</span> - VDOM ID. <span class="li-normal">type: int</span>
 ...
 <td><code class="docutils literal notranslate">v7.2.0 -> v7.2.0 </code></td>
        ...
        <li> <span class="li-head">which</span> - Policy. <span class="li-normal">type: str</span> <span class="li-normal">choices: firewall, interface, interface6, sniffer, sniffer6, explicit, firewall6</span>
