...
.. raw:: html
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.4.4 </code></td>
        ...
        <li> <span class="li-head">gslb_domain_name</span> - Domain to use when integrating with FortiGSLB. <span class="li-normal">type: str</span>
 ...
 <tr>
 <td>gslb_domain_name</td>
 <td><code class="docutils literal notranslate">v7.4.2 -> 7.4.4 </code></td>
 </tr>
 </table>
 </div>
 </li>
        <li> <span class="li-head">gslb_hostname</span> - Hostname to use within the configured FortiGSLB domain. <span class="li-normal">type: str</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.2 -> 7.4.4 </code></td>
        ...
        <li> <span class="li-head">gslb_public_ips</span> - Publicly accessible IP addresses for the FortiGSLB service. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: gslb_public_ips:index</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.2 -> 7.4.4 </code></td>
            ...
            <ul class="ul-self">
            <li> <span class="li-head">index</span> - Index of this public IP setting. see <a href='#notes'>Notes</a>. <span class="li-normal">type: int</span> <span class="li-required">required: true</span>
 ...
 <td><code class="docutils literal notranslate">v7.0.1 -> 7.4.4</code></td>
        ...
        <li> <span class="li-head">one_click_gslb_server</span> - Enable/disable one click GSLB server integration with FortiGSLB. <span class="li-normal">type: str</span> <span class="li-normal">choices: disable, enable</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.4.4</code></td>
        ...
        <li> <span class="li-head">ssl_certificate</span> - Name of the certificate to use for SSL handshake. Source vpn.certificate.local.name. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: ssl_certificate:name</span>
 ...
 <td>name</td>
        ...
        <li> <span class="li-head">ssl_certificate_dict</span> - Name of the certificate to use for SSL handshake. Use the parameter ssl-certificate instead if the fortiOS firmwear <= 7.4.1 <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: ssl_certificate_dict:name</span>
