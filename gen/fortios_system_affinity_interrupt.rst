:source: fortios_system_affinity_interrupt.py
...
.. raw:: html
    ...
    <li> <span class="li-head">system_affinity_interrupt</span> - Configure interrupt affinity. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>system_affinity_interrupt</td>
 ...
 <td><code class="docutils literal notranslate">v7.4.0 -> 7.4.4 </code></td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">affinity_cpumask</span> - Affinity setting (64-bit hexadecimal value in the format of 0xxxxxxxxxxxxxxxxx). <span class="li-normal">type: str</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.0 -> 7.4.4 </code></td>
        ...
        <li> <span class="li-head">id</span> - ID of the interrupt affinity setting. see <a href='#notes'>Notes</a>. <span class="li-normal">type: int</span> <span class="li-required">required: true</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.0 -> 7.4.4 </code></td>
        ...
        <li> <span class="li-head">interrupt</span> - Interrupt name. <span class="li-normal">type: str</span>
