    ...
    - name: Configure user defined IPv6 local-in policies.
      fortinet.fortios.fortios_firewall_local_in_policy6:
          ...
          firewall_local_in_policy6:
              ...
              intf:
                  -
                      name: "default_name_9 (source system.zone.name system.interface.name)"
              ...
              srcaddr:
                  -
                      name: "default_name_16 (source firewall.address6.name firewall.addrgrp6.name system.external-resource.name)"
