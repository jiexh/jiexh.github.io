:source: fortios_firewall_internet_service_fortiguard.py

:orphan:

.. fortios_firewall_internet_service_fortiguard:
...
Synopsis
--------
- This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the user to set and modify firewall feature and internet_service_fortiguard category. Examples include all parameters and values need to be adjusted to datasources before usage. Tested with FOS v6.0.0
...
.. raw:: html
    ...
    <li> <span class="li-head">firewall_internet_service_fortiguard</span> - Configure FortiGuard Internet Services. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>firewall_internet_service_fortiguard</td>
 ...
 <td><code class="docutils literal notranslate">v7.6.4 -> 7.6.2 </code></td>
        ...
        <li> <span class="li-head">entry</span> - Entries added to the Internet Service FortiGuard database. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: entry:id</span>
