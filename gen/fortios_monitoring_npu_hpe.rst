:source: fortios_monitoring_npu_hpe.py
...
.. raw:: html
 ...
 <td><code class="docutils literal notranslate">v7.0.0 -> 7.4.4 </code></td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">interval</span> - HPE status check interval (1 - 60 seconds). <span class="li-normal">type: int</span>
 ...
 <td><code class="docutils literal notranslate">v7.0.0 -> 7.4.4 </code></td>
        ...
        <li> <span class="li-head">multipliers</span> - HPE type interval multipliers (12 integers from <1> to <255>) number of continuous event logs. <span class="li-normal">type: list</span> </li>
        <li> <span class="li-head">status</span> - Enable/disable HPE status monitoring. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
