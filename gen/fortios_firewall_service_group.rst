...
.. raw:: html
 ...
 <td><code class="docutils literal notranslate">v6.4.4 -> 7.4.4</code></td>
        ...
        <li> <span class="li-head">member</span> - Service objects contained within the group. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: member:name</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.4.4 </code></td>
            ...
            <ul class="ul-self">
            <li> <span class="li-head">name</span> - Service or service group name. Source firewall.service.custom.name firewall.service.group.name. <span class="li-normal">type: str</span> <span class="li-required">required: true</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.4.4 </code></td>
        ...
        <li> <span class="li-head">name</span> - Service group name. <span class="li-normal">type: str</span> <span class="li-required">required: true</span>
