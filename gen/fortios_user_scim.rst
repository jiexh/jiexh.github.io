...
Synopsis
--------
- This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the user to set and modify user feature and scim category. Examples include all parameters and values need to be adjusted to datasources before usage. Tested with FOS v6.0.0
...
.. raw:: html
    ...
    <li> <span class="li-head">user_scim</span> - Configure SCIM client entries. <span class="li-normal">type: dict</span>
 ...
 <td><code class="docutils literal notranslate">v7.6.0 -> 7.6.2 </code></td>
        ...
        <li> <span class="li-head">cascade</span> - Enable/disable to follow SCIM users/groups changes in IDP. <span class="li-normal">type: str</span> <span class="li-normal">choices: disable, enable</span>
