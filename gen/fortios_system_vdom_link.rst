...
.. raw:: html
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.4.4 </code></td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">name</span> - VDOM link name (maximum = 11 characters). <span class="li-normal">type: str</span> <span class="li-required">required: true</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.4.4 </code></td>
        ...
        <li> <span class="li-head">type</span> - VDOM link type: PPP or Ethernet. <span class="li-normal">type: str</span> <span class="li-normal">choices: ppp, ethernet, npupair</span>
