...
-----------------------------
Supported Version Ranges: v6.0.0 -> v7.0.8, v7.2.0 -> v7.2.4, v7.4.3 -> 7.4.4
...
.. raw:: html
    ...
    <li> <span class="li-head">gtp_apngrp</span> - Configure APN groups for GTP. <span class="li-normal">type: dict</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.3 -> 7.4.4 </code></td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">member</span> - APN group member. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: member:name</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.3 -> 7.4.4 </code></td>
        ...
        <li> <span class="li-head">name</span> - GTP APN group name. <span class="li-normal">type: str</span> <span class="li-required">required: true</span>
