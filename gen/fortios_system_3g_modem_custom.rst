:source: fortios_system_3g_modem_custom.py
...
.. raw:: html
    ...
    <li> <span class="li-head">system_3g_modem_custom</span> - 3G MODEM custom. <span class="li-normal">type: dict</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.4.4 </code></td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">class_id</span> - USB interface class in hexadecimal format (00-ff). <span class="li-normal">type: str</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.4.4 </code></td>
        ...
        <li> <span class="li-head">init_string</span> - Init string in hexadecimal format (even length). <span class="li-normal">type: str</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.4.4 </code></td>
        ...
        <li> <span class="li-head">model</span> - MODEM model name. <span class="li-normal">type: str</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.4.4 </code></td>
        ...
        <li> <span class="li-head">modeswitch_string</span> - USB modeswitch arguments. For example: "-v 1410 -p 9030 -V 1410 -P 9032 -u 3". <span class="li-normal">type: str</span>
 ...
 <td><code class="docutils literal notranslate">v6.4.4 -> 7.4.4 </code></td>
        ...
        <li> <span class="li-head">product_id</span> - USB product ID in hexadecimal format (0000-ffff). <span class="li-normal">type: str</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.4.4 </code></td>
        ...
        <li> <span class="li-head">vendor</span> - MODEM vendor name. <span class="li-normal">type: str</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.4.4 </code></td>
        ...
        <li> <span class="li-head">vendor_id</span> - USB vendor ID in hexadecimal format (0000-ffff). <span class="li-normal">type: str</span>
