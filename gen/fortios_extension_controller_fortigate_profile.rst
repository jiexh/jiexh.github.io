:source: fortios_extension_controller_fortigate_profile.py
...
Synopsis
--------
- This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the user to set and modify extension_controller feature and fortigate_profile category. Examples include all parameters and values need to be adjusted to datasources before usage. Tested with FOS v6.0.0
...
.. raw:: html
    ...
    <li> <span class="li-head">extension_controller_fortigate_profile</span> - FortiGate connector profile configuration. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>extension_controller_fortigate_profile</td>
 ...
 <td><code class="docutils literal notranslate">v7.2.1 -> 7.4.4 </code></td>
        ...
        <li> <span class="li-head">lan_extension</span> - FortiGate connector LAN extension configuration. <span class="li-normal">type: dict</span>
 ...
 <td><code class="docutils literal notranslate">v7.2.1 -> 7.4.4 </code></td>
        ...
        <li> <span class="li-head">name</span> - FortiGate connector profile name. <span class="li-normal">type: str</span> <span class="li-required">required: true</span>
