...
.. raw:: html
 ...
 <td><code class="docutils literal notranslate">v7.4.0 -> 7.6.0 </code></td>
        ...
        <li> <span class="li-head">ignore_signing_errors</span> - Allow/reject use of FortiGate firmware images that are unsigned. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
