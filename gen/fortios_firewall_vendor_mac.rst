:source: fortios_firewall_vendor_mac.py
...
.. raw:: html
    ...
    <li> <span class="li-head">firewall_vendor_mac</span> - Show vendor and the MAC address they have. <span class="li-normal">type: dict</span>
 ...
 <td><code class="docutils literal notranslate">v7.2.0 -> v7.2.0 </code></td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">id</span> - Vendor ID. see <a href='#notes'>Notes</a>. <span class="li-normal">type: int</span> <span class="li-required">required: true</span>
 ...
 <td><code class="docutils literal notranslate">v7.2.0 -> v7.2.0 </code></td>
        ...
        <li> <span class="li-head">mac_number</span> - Total number of MAC addresses. <span class="li-normal">type: int</span>
 ...
 <td><code class="docutils literal notranslate">v7.2.0 -> v7.2.0 </code></td>
        ...
        <li> <span class="li-head">name</span> - Vendor name. <span class="li-normal">type: str</span>
 ...
 <td><code class="docutils literal notranslate">v7.2.0 -> v7.2.0 </code></td>
        ...
        <li> <span class="li-head">obsolete</span> - Indicates whether the Vendor ID can be used. <span class="li-normal">type: int</span>
