...
.. raw:: html
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.6.2 </code></td>
        ...
        <li> <span class="li-head">internet_service_fortiguard</span> - Application name in the Internet service fortiguard database. Source firewall.internet-service-fortiguard.name. <span class="li-normal">type: str</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.6.2</code></td>
        ...
        <li> <span class="li-head">preferred_source</span> - Preferred source IP for this route. <span class="li-normal">type: str</span>
