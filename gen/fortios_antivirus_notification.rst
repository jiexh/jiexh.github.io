:source: fortios_antivirus_notification.py
...
.. raw:: html
    ...
    <li> <span class="li-head">antivirus_notification</span> - Configure AntiVirus notification lists. <span class="li-normal">type: dict</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> v6.2.7 </code></td>
        ...
        <li> <span class="li-head">entries</span> - modify this antivirus notification list <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: entries:name</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> v6.2.7 </code></td>
            ...
            <ul class="ul-self">
            <li> <span class="li-head">name</span> - virus name or prefix <span class="li-normal">type: str</span> <span class="li-required">required: true</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> v6.2.7 </code></td>
            ...
            <li> <span class="li-head">prefix</span> - enable prefix matches based on this name <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.4.3</code></td> </table>
            ...
            <li> <span class="li-head">status</span> - enable this entry for notifications <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
