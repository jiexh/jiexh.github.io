...
.. raw:: html
 ...
 <td><code class="docutils literal notranslate">v7.4.3 -> 7.6.2 </code></td>
        ...
        <li> <span class="li-head">echo_requires_path_in_use</span> - Block GTP Echo Request if no active tunnel over the associated GTP path. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <tr>
 <td>echo_requires_path_in_use</td>
