:source: fortios_wireless_controller_nac_profile.py
...
.. raw:: html
    ...
    <li> <span class="li-head">wireless_controller_nac_profile</span> - Configure WiFi network access control (NAC) profiles. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>wireless_controller_nac_profile</td>
 ...
 <td><code class="docutils literal notranslate">v7.0.0 -> 7.4.4 </code></td>
        ...
        <li> <span class="li-head">onboarding_vlan</span> - VLAN interface name. Source system.interface.name. <span class="li-normal">type: str</span>
