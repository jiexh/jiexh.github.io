:source: fortios_firewall_internet_service_owner.py
...
.. raw:: html
    ...
    <li> <span class="li-head">firewall_internet_service_owner</span> - Internet Service owner. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>firewall_internet_service_owner</td>
 ...
 <td><code class="docutils literal notranslate">v7.2.0 -> v7.2.0 </code></td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">id</span> - Internet Service owner ID. see <a href='#notes'>Notes</a>. <span class="li-normal">type: int</span> <span class="li-required">required: true</span>
 ...
 <td><code class="docutils literal notranslate">v7.2.0 -> v7.2.0 </code></td>
        ...
        <li> <span class="li-head">name</span> - Internet Service owner name. <span class="li-normal">type: str</span>
