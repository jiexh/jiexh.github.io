:source: fortios_gtp_ie_allow_list.py
...
-----------------------------
Supported Version Ranges: v7.0.0 -> v7.0.8, v7.2.0 -> v7.2.4, v7.4.3 -> 7.4.4
...
.. raw:: html
    ...
    <li> <span class="li-head">gtp_ie_allow_list</span> - IE allow list. <span class="li-normal">type: dict</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.3 -> 7.4.4 </code></td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">entries</span> - Entries of allow list for unknown or out-of-state IEs. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: entries:id</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.3 -> 7.4.4 </code></td>
            ...
            <ul class="ul-self">
            <li> <span class="li-head">fos_message</span> - Message ID (1 - 255). <span class="li-normal">type: int</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.3 -> 7.4.4 </code></td>
            ...
            <li> <span class="li-head">ie</span> - IE ID (1 - 255). <span class="li-normal">type: int</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.3 -> 7.4.4 </code></td>
        ...
        <li> <span class="li-head">name</span> - IE allow list name. <span class="li-normal">type: str</span> <span class="li-required">required: true</span>
