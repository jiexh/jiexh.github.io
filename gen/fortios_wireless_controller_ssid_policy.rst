:source: fortios_wireless_controller_ssid_policy.py
...
.. raw:: html
    ...
    <li> <span class="li-head">wireless_controller_ssid_policy</span> - Configure WiFi SSID policies. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>wireless_controller_ssid_policy</td>
 ...
 <td><code class="docutils literal notranslate">v7.0.0 -> 7.4.4 </code></td>
        ...
        <li> <span class="li-head">vlan</span> - VLAN interface name. Source system.interface.name. <span class="li-normal">type: str</span>
