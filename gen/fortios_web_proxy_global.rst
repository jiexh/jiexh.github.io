...
.. raw:: html
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.6.2 </code></td>
        ...
        <li> <span class="li-head">http2_client_window_size</span> - HTTP/2 client initial window size in bytes (65535 - 2147483647). <span class="li-normal">type: int</span>
 ...
 <tr>
 <td>http2_client_window_size</td>
 <td><code class="docutils literal notranslate">v7.6.3 -> 7.6.2 </code></td>
 </tr>
 </table>
 </div>
 </li>
        <li> <span class="li-head">http2_server_window_size</span> - HTTP/2 server initial window size in bytes (65535 - 2147483647). <span class="li-normal">type: int</span>
 ...
 <tr>
 <td>http2_server_window_size</td>
 <td><code class="docutils literal notranslate">v7.6.3 -> 7.6.2 </code></td>
 </tr>
 </table>
 </div>
 ...
 <td><code class="docutils literal notranslate">v7.4.2 -> v7.6.2 </code></td>
 </tr>
 <tr>
 <td>[enable]</td>
 <td><code class="docutils literal notranslate">v7.4.2 -> v7.6.2</code></td>
 ...
 <td><code class="docutils literal notranslate">v7.4.2 -> v7.6.2</code></td>
        ...
        <li> <span class="li-head">proxy_fqdn</span> - Fully Qualified Domain Name of the explicit web proxy  that clients connect to. <span class="li-normal">type: str</span>
 ...
 <td><code class="docutils literal notranslate">v7.6.1 -> 7.6.2</code></td>
        ...
        <li> <span class="li-head">ssl_ca_cert</span> - SSL CA certificate for SSL interception. Source vpn.certificate.local.name vpn.certificate.hsm-local.name. <span class="li-normal">type: str</span>
