...
.. raw:: html
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.6.2 </code></td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">allow_routing</span> - Enable/disable use of this group in routing configurations. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td><code class="docutils literal notranslate">v6.2.0 -> 7.6.2</code></td>
        ...
        <li> <span class="li-head">exclude_member</span> - Address exclusion member. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: exclude_member:name</span>
