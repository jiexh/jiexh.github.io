...
.. raw:: html
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.4.4 </code></td>
        ...
        <li> <span class="li-head">entries</span> - Configure content types used by web filter. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: entries:pattern</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.4.4</code></td>
            ...
            <li> <span class="li-head">category</span> - Categories that this content type applies to. <span class="li-normal">type: list</span> </li>
