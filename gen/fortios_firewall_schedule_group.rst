...
.. raw:: html
 ...
 <td><code class="docutils literal notranslate">v6.4.4 -> 7.4.4</code></td>
        ...
        <li> <span class="li-head">member</span> - Schedules added to the schedule group. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: member:name</span>
