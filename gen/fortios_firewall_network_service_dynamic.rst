:source: fortios_firewall_network_service_dynamic.py
...
Synopsis
--------
- This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the user to set and modify firewall feature and network_service_dynamic category. Examples include all parameters and values need to be adjusted to datasources before usage. Tested with FOS v6.0.0
...
.. raw:: html
    ...
    <li> <span class="li-head">firewall_network_service_dynamic</span> - Configure Dynamic Network Services. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>firewall_network_service_dynamic</td>
 ...
 <td><code class="docutils literal notranslate">v7.2.1 -> 7.4.4 </code></td>
        ...
        <li> <span class="li-head">name</span> - Dynamic Network Service name. <span class="li-normal">type: str</span> <span class="li-required">required: true</span>
