:source: fortios_emailfilter_block_allow_list.py
...
.. raw:: html
    ...
    <li> <span class="li-head">emailfilter_block_allow_list</span> - Configure anti-spam block/allow list. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>emailfilter_block_allow_list</td>
 ...
 <td><code class="docutils literal notranslate">v7.0.0 -> 7.4.3 </code></td>
        ...
        <li> <span class="li-head">entries</span> - Anti-spam block/allow entries. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: entries:id</span>
 ...
 <td><code class="docutils literal notranslate">v6.0.0 -> 7.4.3</code></td> </table>
            ...
            <li> <span class="li-head">type</span> - Entry type. <span class="li-normal">type: str</span> <span class="li-normal">choices: ip, email-to, email-from, subject, email</span>
