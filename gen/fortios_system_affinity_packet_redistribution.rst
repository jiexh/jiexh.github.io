:source: fortios_system_affinity_packet_redistribution.py
...
.. raw:: html
    ...
    <li> <span class="li-head">system_affinity_packet_redistribution</span> - Configure packet redistribution. <span class="li-normal">type: dict</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.0 -> 7.4.4 </code></td>
        ...
        <li> <span class="li-head">id</span> - ID of the packet redistribution setting. see <a href='#notes'>Notes</a>. <span class="li-normal">type: int</span> <span class="li-required">required: true</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.0 -> 7.4.4 </code></td>
        ...
        <li> <span class="li-head">interface</span> - Physical interface name on which to perform packet redistribution. Source system.interface.name. <span class="li-normal">type: str</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.0 -> 7.4.4 </code></td>
        ...
        <li> <span class="li-head">round_robin</span> - Enable/disable round-robin redistribution to multiple CPUs. <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
 ...
 <td><code class="docutils literal notranslate">v7.4.0 -> 7.4.4</code></td>
        ...
        <li> <span class="li-head">rxqid</span> - ID of the receive queue (when the interface has multiple queues) on which to perform packet redistribution (255 = all queues). <span class="li-normal">type: int</span>
